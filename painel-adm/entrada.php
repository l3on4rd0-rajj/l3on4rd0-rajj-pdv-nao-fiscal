            ...
            <div class="card my-4">
                <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
                    <div class="bg-gradient-secondary shadow-secondary border-radius-lg pt-4 pb-3 d-flex justify-content-between container-fluid">
                        <h6 class="text-white ps-3">Entrada de Produtos</h6>
                        <a href="index.php?pagina=<?php echo $pagina ?>&funcao=finalizar" type="button" class="btn btn-outline-light btn-sm mb-0">Finalizar Nota</a>
                    </div>
                </div>
                            ...
                            <table id="table" class="table table-hover align-items-center mb-0">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">Custo</th>
                                ...
                                <tbody>
                                    ...
                                    ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <p class="text-center text-xs font-weight-bold mb-0">R$ <?php echo number_format($custo_produto, 2, ',', '.'); ?></p>
                                            </td>
...
if (@$_GET['funcao'] == "editar") {
    ...
    $query = $pdo->query("SELECT * from itens_entrada where id = '$_GET[id]'");
    $res = $query->fetchAll(PDO::FETCH_ASSOC);
    $total_reg = @count($res);
    if ($total_reg > 0) {
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control px-2 py-1 border-radius-lg text-sm" style="border: 1px solid #ccc;" id="custo" name="custo" value="<?php echo @$custo ?>" required>
                            </div>
                        </div>
...
<div class="modal fade" tabindex="-1" id="modalFinalizar" data-bs-backdrop="static">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Finalizar Nota</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            ...
            <form method="POST" id="form-finalizar">
                <div class="modal-body">
                    ...
                    <p>Para confirmar a entrada desses produtos em estoque, relacione-os a um fornecedor previamente cadastrado:</p>

                    <select class="px-2 py-1 border-radius-lg w-70 text-sm text-uppercase bg-light" name="fornecedor">
                        ...
                        <?php }
                            ...
                            echo '<option value="">Nenhum fornecedor cadastrado!</option>';
                        } ?>
...
<script type="text/javascript">
    $('#busca').keyup(function() {
        var busca = $('#busca').val();
        $.post('buscar-produto-entrada.php', {
            busca: busca
        }, function(data) {
            $('#result').html(data);
        });
