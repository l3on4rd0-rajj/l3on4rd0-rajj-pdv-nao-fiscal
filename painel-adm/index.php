...
<body class="g-sidenav-show  bg-gray-200">
				...
				<ul class="navbar-nav">
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							...
							<li><a class="dropdown-item" href="index.php?pagina=<?php echo $menu4 ?>">Categorias</a></li>
							<li><a class="dropdown-item" href="index.php?pagina=<?php echo $menu5 ?>">Produtos</a></li>
							<li><a class="dropdown-item" href="index.php?pagina=<?php echo $menu6 ?>">Clientes</a></li>
						</ul>
					</li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<li><a class="dropdown-item" href="index.php?pagina=<?php echo $menu8 ?>">Entrada</a></li>
							<li><a class="dropdown-item" href="index.php?pagina=<?php echo $menu9 ?>">Balanço</a></li>
						</ul>
					</li>

					<li class="nav-item">
						<a class="nav-link" href="index.php?pagina=<?php echo $menu7 ?>">Vendas</a>
					</li>
					...
					<li class="nav-item dropdown">
						...
						<ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
							<li><a class="dropdown-item" href="../rel/relProdutos_class.php" target="_blank">Catálogo Padrão</a></li>
							<li><a class="dropdown-item" href="../rel/relAdm_class.php" target="_blank">Catálogo Administrativo</a></li>
						</ul>
					</li>
	...
	elseif (@$_GET['pagina'] == $menu7) {
		require_once($menu7.'.php');
	}

	elseif (@$_GET['pagina'] == $menu8) {
		require_once($menu8.'.php');
	}

	elseif (@$_GET['pagina'] == $menu9) {
		...
		<div class="modal-content">
			...
			<form method="POST" id="form-perfil">
				<div class="modal-body">
					...
					<p>Para alterar mais informações vá em: .. / Cadastro / Usuários</p>
